...
def get_arguments():
    ...
    parser.add_argument("--snapshot_dir", type=str, default='/home/liruimin/SG-One-master/snapshots_1way1shot_heat')
...
def val(args):
    ...
    for group in range(4):
        ...
        for count in tqdm(range(1000)):
            ...
            logits_A, logits_B  = model.forward_1way_1shot_heat(query_img_var, ref_img_var, query_label_var, ref_label_var)  # logits_A =
