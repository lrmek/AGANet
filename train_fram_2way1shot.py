...
def get_arguments():
    ...
    parser.add_argument("--max_steps", type=int, default=160001)
    ...
    parser.add_argument("--split", type=str, default='2way_train')
...
def train(args):
    ...
    for dat in train_loader:
        ...
        #logits_B = model.forward_2way_1shot_avg(query_img, support_img, support_mask)
        logits_A_one, logits_A_two, logits_B = model.forward_2way_1shot_avg(query_img, support_img, support_mask)

        loss_A_one, cluster_loss, loss_bce = model.get_2way_loss(logits_A_one, support_mask[0][0])
        loss_A_two, cluster_loss, loss_bce = model.get_2way_loss(logits_A_two, support_mask[1][0])
        loss_val_A = loss_A_one + loss_A_two
