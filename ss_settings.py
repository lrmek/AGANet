...
empty_profile_2way = Map(
                ...
                first_label_params=[('first_label', 1., 0.)],
                second_label_params=[('second_label', 1., 0.)],
                third_label_params=[('third_label', 1., 0.)],
                ###############################################
                n_way = 2,
                k_shot=1,
                first_shape=None,
...
# fold0_2way_5shot_test = Map(empty_profile_2way,
#     output_type='image_pair',
#     db_cycle = 1000,
#     read_mode='deterministic',
#     image_sets=['pascal_test'],
...
#fold0_2way_1shot_test = Map(fold0_2way_5shot_test, k_shot=1)
...
fold1_3shot_test = Map(fold1_5shot_test, k_shot=3)
# fold1_2way_5shot_test = Map(fold0_2way_5shot_test, pascal_cats=get_cats('test', 1))
# fold1_2way_1shot_test = Map(fold1_2way_5shot_test, k_shot=1)
...
fold2_3shot_test = Map(fold2_5shot_test, k_shot=3)
# fold2_2way_5shot_test = Map(fold0_2way_5shot_test, pascal_cats=get_cats('test', 2))
# fold2_2way_1shot_test = Map(fold2_2way_5shot_test, k_shot=1)
...
fold3_3shot_test = Map(fold3_5shot_test, k_shot=3)
#
# fold3_2way_5shot_test = Map(fold0_2way_5shot_test, pascal_cats=get_cats('test', 3))
# fold3_2way_1shot_test = Map(fold3_2way_5shot_test, k_shot=1)
